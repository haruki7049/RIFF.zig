...
Read this to understand the commit policy and message conventions for `RIFF.zig`.
...
- `feat: support WAVE_FORM chunk validation`
- `fix: reject a fmt chunk with zero channels`
